	...
	<div class="container">
		...
		<h3 class="text-center">Registro usuario</h3>
			<div class="row">
				...
				<div class="col-xs-8">
                                    <form class="form-horizontal" role="form" action="../ServletRegistrarUsuario" method="post">
					  
					  <div class="form-group">
					    <label for="identificador" class="col-lg-2 control-label">Nombre:</label>
					    <div class="col-lg-4">
					      <input type="text" class="form-control" name="nombre" placeholder="Nombre(s):" required title="Ingresa un nombre">
					    </div>
					    <div class="col-lg-3">
					      <input type="text" class="form-control" name="pApellido" placeholder="Primer apellido" required title="Ingresa el primer apellido">
					    </div>
					    <div class="col-lg-3">
					      <input type="text" class="form-control" name="sApellido" placeholder="Segundo apellido" required title="Ingresa un segundo apellido">
					    </div>
					  ...
					  <div class="row" id="tipoSelect">
						      ...
						      <span class="input-group-addon">
                                                          <input type="radio" value="6" id="alumno" name="tipo" class="text-cen" required>
                                                        <label for="alumno">Alumno</label>
						      </span>

						      <span class="input-group-addon">
                                                          <input type="radio" value="7" id="docente" name="tipo">
						        <label for="docente">Docente</label>
						      </span>
						      
						      <span class="input-group-addon">
                                                          <input type="radio" value="8" id="administrativo" name="tipo">
						        <label for="administrativo">Administrativo</label>
						      </span>

						      <span class="input-group-addon">
                                                          <input type="radio" value="9" id="seguridad" name="tipo">
				      ...
				      <div class="form-group">
					    ...
					    <div class="col-lg-10">
					      <select name="plantel" id="plantel" class="form-control">
                                                  ...
                                                  <option value="3">ESIA Tecamachalco</option>
                                                  <option value="4">ESIME TICOMAN</option>
					      </select>
					    </div>
					  </div>
					...
					<div class="form-group">
					    ...
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="identificador" name="identificador" placeholder="#########" required>
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-10">
                                                <input type="email" class="form-control" id="correo" name="correo" placeholder="ejemplo@ipn.com.mx">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-5">
                                                <input type="password" class="form-control" id="contrasenia1" name="contrasenia1" placeholder="Contrase&ntilde;a 1">
					    </div>
					    <div class="col-lg-5">
                                                <input type="password" class="form-control" id="contrasenia2" name="contrasenia2" placeholder="Contrase&ntilde;a 2">
					    </div>
					  </div>
					...
					<div class="form-group">
					    ...
					    <div class="col-lg-10">
							  <div class="input-group ">
						      <span class="input-group-addon">
						        <input type="radio" id="Femenino" name="sexo" class="text-cen" required value="femenino">
						        <label for="Femenino">Femenino</label>
						      </span>

						      <span class="input-group-addon">
						        <input type="radio" id="docente" name="sexo" value="masculino">
					...
					<div class="form-group">
					    ...
					    <div class="col-lg-10">
                                                <input type="number" class="form-control" id="edad" placeholder="" name="edad" min="15" required>
					    </div>
					  </div>
					...
					<div class="form-group">
					    ...
					    <div class="col-lg-5">
                                                <input type="text" class="form-control" id="movil" name="movil" placeholder="Telefono m&oacute;vil">
					    </div>
					  </div>
