...
<head>
	...
	<title>SISAP - Registrar Notificaci&oacute;n</title>
</head>
<body>
	<div class="container">
		<!-- Encabezado -->
		...
		<!-- Cuerpo  -->
		<div id="cuerpo">
		<h3 class="text-center">Registrar Notificaci&oacute;n</h3>
		<div class="row">
				...
				<div class="col-xs-8">
					<form class="form-horizontal" role="form">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="identificador" placeholder="Ingresa el asunto de la notificaci&oacute;n" required title="Ingresa el nombre del plantel">
					    </div>
					  </div>
