...
<head>
	...
	<title>SISAP - Buscar usuario</title>
</head>
<body>
	<div class="container">
		<!-- Encabezado -->
		...
		<!-- Cuerpo  -->
		<div id="cuerpo">
			<h3 class="text-center" id="titulo">Buscar usuario</h3>
			<div class="row">
				<div class="col-xs-2"></div>
				<div class="col-xs-8">
					<form class="form-horizontal" role="form" action="./gestionUsuario.jsp">
					  <div class="form-group">
					    <label for="correo" class="col-lg-2 control-label">Email:</label>
					    <div class="col-lg-10">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="nombre" placeholder="Gerar Haran Rodriguez Molina">
					    </div>
					  </div>
					  <div class="form-group">
