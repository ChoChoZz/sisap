        ...
        <div class="container">
            ...
            <div id="cuerpo">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        <form class="form-horizontal" role="form" action="../ServletSave" method="post">

                            <div class="form-group">
                                <label for="identificador" class="col-lg-2 control-label">Nombre:</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre del Plantel" required title="Ingresa el nombre del plantel">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select name="nivel" id="nivel" class="form-control">
                                        <option value="1">Escuela de nivel superior</option>
                                        <option value="2">Escuela de nivel medio superior</option>
                                        <option value="3">Plantel Administrativo</option>
                                        <option value="4">CENDI</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="coordenada0" id="coordenada0" placeholder="Latitud" required name="coordenada0">
                                </div>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="coordenada1" name="coordenada1" placeholder="Longitud" required name="coordenada1">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" id="telefonoFijo" name="telefonoFijo" placeholder="Telefono fijo" required>
                                </div>
                                <div class="col-lg-5">
