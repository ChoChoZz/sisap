...
<head>
	...
	<title>SISAP - Buscar isntituci&oacute;n</title>
</head>
<body>
	<div class="container">
		<!-- Encabezado -->
		...
		<!-- Cuerpo  -->
		<div id="cuerpo">
			<h3 class="text-center" id="titulo">Buscar Plantel</h3>
			<div class="row">
				<div class="col-xs-2"></div>
				<div class="col-xs-8">
					<form class="form-horizontal" role="form" action="gestionInstitucion.jsp">
