...
<head>
	...
	<title>SISAP - Buscar Notificaci&oacute;n</title>
</head>
<body>
	<div class="container">
		<!-- Encabezado -->
		...
		<!-- Cuerpo  -->
		<div id="cuerpo">
		<h3 class="text-center">Buscar Notificaci&oacute;n</h3>
			<div class="row">
				<div class="col-xs-2"></div>
				<div class="col-xs-8">
					<form class="form-horizontal" role="form" action="./gestionAlerta.jsp">
					  <div class="form-group">
					    <label for="identificadorAlerta" class="col-lg-2 control-label">Identificador:</label>
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="identificadorAlerta" placeholder="#Identificador" >
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="descripcionAlerta" class="col-lg-2 control-label">Descripcion:</label>
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="descripcionAlerta" placeholder="Breve descripci&oacute;n de la Notificaci&oacute;n" >
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="tipo" class="col-lg-2 control-label">Tipo:</label>
					    <div class="col-lg-10">
					      <input type="text" class="form-control" id="tipo" placeholder="Tipo de notificaci&oacute;n">
					    </div>
					  </div>
		              <div class="form-group">
